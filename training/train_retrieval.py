"""
Training Script for Direction 1: Retrieval Feature Network
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Train Retrieval Network (Direction 1)')

    parser.add_argument('--config', type=str,
                        default='/home/wzj/pan1/contour_deep_1/configs/config_base.yaml',
                        help='Base config file')
    parser.add_argument('--train_config', type=str,
                        default='/home/wzj/pan1/contour_deep_1/configs/config_retrieval.yaml',
                        help='Training config file')
    parser.add_argument('--train_pickle', type=str,
                        default='/home/wzj/pan1/contour_deep_1/data/training_queries_chilean_period.pickle',
                        help='Training queries pickle')
    parser.add_argument('--test_pickle', type=str,
                        default='/home/wzj/pan1/contour_deep_1/data/test_queries_chilean_period.pickle',
